...
class RecruitmentRequest(models.Model):
    ...
    def _send_activity_to_hr(self):
        ...
        self.ensure_one()
        hr_group = self.env.ref('M02_P0205_00.group_hr_validator', raise_if_not_found=False)
        if not hr_group:
    ...
    def _send_activity_to_ceo(self):
        ...
        self.ensure_one()
        ceo_group = self.env.ref('M02_P0205_00.group_ceo_recruitment', raise_if_not_found=False)
        self._schedule_activity_for_group(
            ceo_group,
