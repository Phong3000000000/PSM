...
Điều chỉnh lại cách xác định kết quả từng vòng phỏng vấn trong module `M02_P0205_00` theo nguyên tắc:
...
Logic hiện tại đang nằm chủ yếu trong file `addons/M02_P0205_00/models/hr_applicant.py`:
...
- `addons/M02_P0205_00/security/ir.model.access.csv`
...
- Vòng 3 - BOD:
  - lấy danh sách ứng viên người phỏng vấn chính từ group `M02_P0205_00.group_bod_recruitment`
  - source data thực tế là `res.groups.users`
- Vòng 4 - ABU:
  - lấy danh sách ứng viên người phỏng vấn chính từ group `M02_P0205_00.group_abu_recruitment`
  - source data thực tế là `res.groups.users`
