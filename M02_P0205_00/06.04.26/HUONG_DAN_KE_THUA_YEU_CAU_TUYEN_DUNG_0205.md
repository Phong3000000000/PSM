...
Tài liệu này dành cho dev cần đọc, kế thừa, mở rộng hoặc tích hợp với chức năng `Yêu Cầu Tuyển Dụng` trong module `M02_P0205_00`.
...
- `addons/M02_P0205_00/models/recruitment_request.py`
...
- `addons/M02_P0205_00/models/recruitment_approval.py`
...
- `addons/M02_P0205_00/views/recruitment_request_views.xml`
...
- `addons/M02_P0205_00/views/approval_request_views.xml`
...
- `addons/M02_P0205_00/data/approval_category_data.xml`
...
- `M02_P0205_00.group_gdh_rst_office_recruitment_mgr`
...
- kiểm tra module `M02_P0205_00` đã upgrade chưa
