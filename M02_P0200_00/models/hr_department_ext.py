...
class HrDepartment(models.Model):
    ...
    def action_generate_positions(self):
        ...
        for default_pos in defaults:
            if default_pos.code in existing_codes:
                continue
            self.env['hr.job'].create({
                ...
                'department_id': self.id,
                'contract_type_id': default_pos.contract_type_id.id if default_pos.contract_type_id else False,
            })
            created_count += 1
