...
class PortalContactController(http.Controller):
    ...
    def portal_contact_page(self, **post):
        ...
        return request.render('M02_P0211_00.portal_contact_form', {
            'partner': partner,
    ...
    def update_contact_info(self, **post):
        ...
        try:
            ...
            return request.redirect('/my/update_info?success=1#onboard')
            
        except Exception as e:
            return request.redirect('/my/update_info?error=1#onboard')
