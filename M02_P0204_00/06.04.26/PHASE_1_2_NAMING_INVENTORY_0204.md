...
Tai lieu nay chot pham vi va mapping doi ten cho `M02_P0204_00` theo quy uoc:
...
Dang duoc tham chieu boi module ngoai `M02_P0204_00`:
...
Hien thay tham chieu chu yeu noi bo trong `M02_P0204_00` (models, controllers, views, ACL). Risk thap hon so voi `interview.schedule`, nhung van can migration data + `res_model`.
