...
và document_approval_status = 'refused' sau khi wizard Refuse xác nhận.
...
class ApplicantGetRefuseReasonLine(models.TransientModel):
    _name = 'applicant.get.refuse.reason.line'
...
class ApplicantGetRefuseReason(models.TransientModel):
    ...
    wizard_line_ids = fields.One2many('applicant.get.refuse.reason.line', 'wizard_id', string='Danh sách lý do')
    ...
    def action_refuse_reason_apply(self):
        ...
        sau đó đồng bộ stage_id = Reject + document_approval_status = 'refused'
        + reject_reason = tên lý do từ chối
        + gửi email từ chối custom.
        """
        rejection_template = self.env.ref(
            'M02_P0204_00.email_rejection', raise_if_not_found=False
        )
        sys_refuse_reason = self.env.ref('M02_P0204_00.system_refuse_reason', raise_if_not_found=False)
