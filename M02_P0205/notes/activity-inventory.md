# Danh sách activity đang được tạo trong module `M02_P0205`
...
- File: `addons/M02_P0205/models/hr_applicant.py`
...
- File: `addons/M02_P0205/models/survey_ext.py`
- Thời điểm tạo:
...
- Phân cho ai:
  - toàn bộ user trong group `M02_P0205.group_bod_recruitment`
- Ý nghĩa:
...
- Phân cho ai:
  - toàn bộ user trong group `M02_P0205.group_abu_recruitment`
- Ý nghĩa:
...
- File: `addons/M02_P0205/models/recruitment_request.py`
...
- Phân cho ai:
  - group `M02_P0205.group_hr_validator`
...
- Phân cho ai:
  - group `M02_P0205.group_ceo_recruitment`
- Ghi chú rất quan trọng:
...
- File: `addons/M02_P0205/models/recruitment_plan.py`
- Thời điểm tạo:
...
- File: `addons/M02_P0205/models/mail_activity.py`
- Chức năng:
