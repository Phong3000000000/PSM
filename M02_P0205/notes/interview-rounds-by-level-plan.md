# Plan tùy chỉnh số lượng vòng phỏng vấn theo `level_id` của module `M02_P0200`

## Mục tiêu

Điều chỉnh flow phỏng vấn của module `M02_P0205` để số lượng vòng phỏng vấn không còn cố định cho mọi vị trí, mà được quyết định theo `level_id` của `hr.job` đang có trong module `M02_P0200`.
...
Sau khi rà lại module `M02_P0200` bản mới:

### 1. Level đã là model riêng

File:

- `addons/M02_P0200/models/hr_job_level.py`
...
- `addons/M02_P0200/models/hr_job_ext.py`
...
- `addons/M02_P0200/models/hr_job_position_default.py`
...
- `addons/M02_P0200/views/hr_job_level_views.xml`
...
- `addons/M02_P0200/views/hr_job_views.xml`
  - gắn `level_id` trực tiếp trên form/tree của `hr.job`
- `addons/M02_P0200/views/hr_job_position_default_views.xml`
...
- `addons/M02_P0200/data/hr_job_level_data.xml`
...
Module `M02_P0205` hiện vẫn đang xây theo khung 4 vòng cứng:
...
- `addons/M02_P0205/models/interview_round.py`
...
- `addons/M02_P0205/__manifest__.py`
- `addons/M02_P0205/models/hr_applicant.py`

Việc cần làm:

- thêm dependency `M02_P0200` vào `0205`
...
- `addons/M02_P0205/models/hr_applicant.py`
- `addons/M02_P0205/data/mail_template_data.xml`
