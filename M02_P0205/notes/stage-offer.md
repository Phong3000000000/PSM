# Stage Offer trong module `M02_P0205`

## File định nghĩa Stage Offer

Stage `Offer` được khai báo trong file `addons/M02_P0205/data/office_stages.xml`.
...
Hành vi kiểu “khi đến một stage thì thực hiện một hành động nào đó” trong module `0205` chủ yếu được xử lý tại file `addons/M02_P0205/models/hr_applicant.py`.
...
Khi ứng viên đang ở stage `Offer` (`stage_office_proposal`), giao diện form trong file `addons/M02_P0205/views/hr_applicant_views.xml` hiển thị hai nút chính:
...
Phần logic chi tiết nằm chủ yếu trong file `addons/M02_P0205/models/hr_applicant.py`, còn phần hiển thị nút thao tác nằm trong `addons/M02_P0205/views/hr_applicant_views.xml`.
