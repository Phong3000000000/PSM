...
Tài liệu này tách plan `interview rounds by level` thành các phase triển khai code cụ thể trong `M02_P0205`, để có thể thực hiện lần lượt và kiểm soát rủi ro tốt hơn.

Plan gốc tham chiếu:

- `addons/M02_P0205/notes/interview-rounds-by-level-plan.md`
