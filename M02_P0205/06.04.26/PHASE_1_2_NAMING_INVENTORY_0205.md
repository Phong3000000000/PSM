...
Tai lieu nay chot pham vi va inventory doi ten cho module `M02_P0205` theo file rule moi:
...
| Doi tuong | Xu ly |
| --- | --- |
| Technical module folder `M02_P0205` | chua doi trong phase nay |
...
- `env.ref('M02_P0205...')` trong Python
- `groups="M02_P0205.*"` trong XML
- `has_group('M02_P0205.*')` trong Python
