# Kiểm tra xung đột `M02_P0205` với danh sách module vừa cập nhật
...
- Điểm overlap lớn nhất nằm giữa `M02_P0205` và `M02_P0211_00` trên model `hr.applicant`.
- Có overlap UI nhẹ giữa `M02_P0205` và `M02_P0209_03` trên model `hr.job`.
...
### `M02_P0205` vs `M02_P0211_00`

- `M02_P0205` đang khai báo phụ thuộc vào `M02_P0211_00`, nên `0211` được load trước và `0205` load sau: [addons/M02_P0205/__manifest__.py](./__manifest__.py)
...
Tham chiếu:
- [addons/M02_P0205/models/hr_job.py](./models/hr_job.py)
- [addons/M02_P0205/views/hr_job_views.xml](./views/hr_job_views.xml)
...
Tham chiếu:
- [addons/M02_P0205/views/portal_templates.xml](./views/portal_templates.xml)
