# -*- coding: utf-8 -*-
{
    ...
    "description": """
        M02_P0205 - Quy trình tuyển dụng khối văn phòng.
    ...
    "data": [
        ...
        "security/recruitment_request_rules.xml",
        ...
        # Legacy one-time cleanup XMLs are intentionally not loaded:
        # - data/stage_cleanup.xml
        # - data/deactivate_store_stages.xml
        # - data/office_action_filter.xml
