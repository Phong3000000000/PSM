...
class HrApplicantOjeEvaluation(models.Model):
    _name = 'x_psm_hr_applicant_oje_evaluation'
    ...
    section_ids = fields.One2many('x_psm_hr_applicant_oje_evaluation_section', 'evaluation_id', string='Sections')
    line_ids = fields.One2many('x_psm_hr_applicant_oje_evaluation_line', 'evaluation_id', string='Chi tiết đánh giá')
...
class HrApplicantOjeEvaluationSection(models.Model):
    _name = 'x_psm_hr_applicant_oje_evaluation_section'
    _description = 'Applicant OJE Evaluation Section'
    _order = 'sequence, id'

    evaluation_id = fields.Many2one('x_psm_hr_applicant_oje_evaluation', string='Evaluation', ondelete='cascade', required=True)
    ...
    line_ids = fields.One2many('x_psm_hr_applicant_oje_evaluation_line', 'section_id', string='Lines')
...
class HrApplicantOjeEvaluationLine(models.Model):
    _name = 'x_psm_hr_applicant_oje_evaluation_line'
    _description = 'Applicant OJE Evaluation Line'
    _order = 'sequence, id'

    evaluation_id = fields.Many2one('x_psm_hr_applicant_oje_evaluation', string='Evaluation', ondelete='cascade', required=True)
    section_id = fields.Many2one('x_psm_hr_applicant_oje_evaluation_section', string='Section', ondelete='cascade')
