...
class InterviewSchedule(models.Model):
    ...
    """
    _name = 'x_psm_interview_schedule'
    ...
    def _cron_auto_create_next_week_schedules(self):
        ...
        # 1. Tìm tất cả x_psm_interview_schedule của tuần hiện tại với state = 'confirmed'
    ...
    def _sync_survey_q14_answers(self):
        ...
        Q14_MAP = [
            (
                'M02_P0204.ft_q14_ans1',
                'M02_P0204.ft_q14_ans2',
                'M02_P0204.ft_q14_ans3',
            ),
        ]
