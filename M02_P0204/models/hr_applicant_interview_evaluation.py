...
class HrApplicantInterviewEvaluation(models.Model):
    _name = "x_psm_hr_applicant_interview_evaluation"
    ...
    section_ids = fields.One2many(
        "x_psm_hr_applicant_interview_evaluation_section",
        "evaluation_id",
        string="Sections",
    )
    line_ids = fields.One2many(
        "x_psm_hr_applicant_interview_evaluation_line",
        "evaluation_id",
        string="Lines",
    )
...
class HrApplicantInterviewEvaluationSection(models.Model):
    _name = "x_psm_hr_applicant_interview_evaluation_section"
...
class HrApplicantInterviewEvaluationLine(models.Model):
    _name = "x_psm_hr_applicant_interview_evaluation_line"
