{
    'name': 'M02_P0209_02 - L&D & People Development',
    'version': '19.0.2.0.0',
    'category': 'Human Resources/Training',
    'summary': 'McDonald\'s OPS Personnel Capability Development Process',
    'description': """
        M02_P0209_01 - Quy Trình Phát Triển Năng Lực Nhân Viên OPS
        ========================================================
        Process Flow:
    ...
    'assets': {
        'web.assets_frontend': [
            'M02_P0209_02/static/src/js/soc_evaluation.js',
            'M02_P0209_02/static/src/js/soc_trainer_evaluation.js',
            'M02_P0209_02/static/src/js/soc_course_fullscreen_player.js',
        ],
    },
    'author': 'PSM',
    'depends': ['base', 'mail', 'website_slides', 'hr_skills', 'planning', 'portal', 'point_of_sale', 'M02_P0206_00', 'portal_custom', 'M04_P0400_00'],
    'data': [
        'security/security_rules.xml',
        'security/ir.model.access.csv',
        'data/ir_sequence_data.xml',
        'data/soc_configuration_data.xml',
        'data/soc_server_actions_config.xml',
        ...
        'views/soc_configuration_views.xml',
